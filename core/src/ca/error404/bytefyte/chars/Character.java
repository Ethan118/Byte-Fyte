...
//                If no attack keys are pressed, the user is not attacking
    ...
    /*
    * Pre: States for the user to be in
    * Post: The user is set to the correct animation, attack, and movement state
    * */
...
//        Ensures attacks are disabled directly after an up special ability
    ...
    /*
    * Pre: An x and y coordinate to reset the player to
    * Post: Player loses a life, and is reset to the desired position if they have a life remaining
    * */
